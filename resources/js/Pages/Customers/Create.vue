                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        <div class="p-2 w-full">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="radio" id="gender" name="gender" v-model="form.gender" value="0" class="">
                                                <label class="ml-2 mr-4">男性</label>
                                                <input type="radio" id="gender" name="gender" v-model="form.gender" value="1" class="">
                                                <label class="ml-2 mr-4">女性</label>
                                                <input type="radio" id="gender" name="gender" v-model="form.gender" value="2" class="">
